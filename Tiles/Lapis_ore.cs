...
{
	public class Lapis_ore : ModTile
	{
	...
	public class Lapis_oreSystem : ModSystem
	{
		public static LocalizedText Lapis_orePassMessage { get; private set; }

		public override void SetStaticDefaults() {
			Lapis_orePassMessage = Mod.GetLocalization($"WorldGen.{nameof(Lapis_orePassMessage)}");
		}
		...
		public override void ModifyWorldGenTasks(List<GenPass> tasks, ref double totalWeight) {
			...
			if (ShiniesIndex != -1) {
				...
				tasks.Insert(ShiniesIndex + 1, new Lapis_orePass("Lapis Ores", 237.4298f));
			}
		}
	}

	public class Lapis_orePass : GenPass
	{
		public Lapis_orePass(string name, float loadWeight) : base(name, loadWeight) {
		}
		...
		protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration) {
			...
			progress.Message = Lapis_oreSystem.Lapis_orePassMessage.Value;
			...
			for (int k = 0; k < (int)(Main.maxTilesX * Main.maxTilesY * 6E-05); k++) {
				...
				WorldGen.TileRunner(x, y, WorldGen.genRand.Next(3, 8), WorldGen.genRand.Next(4, 8), ModContent.TileType<Lapis_ore>());
