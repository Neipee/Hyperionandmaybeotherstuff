using Hyperionandmaybeotherstuff.Items.weapon;
...
namespace Hyperionandmaybeotherstuff.projectiles
{
	...
	{
		public override string Texture => "Hyperionandmaybeotherstuff/Items/weapon/Hyperionbeam";
